...
<div class="flex items-center gap-4 mb-6">
    ...
    <div class="relative">
    <input type="text" id="searchMonitoring" placeholder="Search device..." onkeyup="filterMonitoring()"
        class="pl-8 pr-4 py-2 border border-gray-300 rounded-lg text-sm
        focus:outline-none focus:ring-2 focus:ring-blue-300 bg-white w-48"/>
